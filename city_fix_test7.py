...
texts = [
    ...
    ("FP19", "Berlin, Germany is the capital"),
    ("FP20", "Avenue, NY 10001"),  # "Avenue" as fake city
    ("FP21", "Let me check New York, NY 10001"),
    ...
    ("FP25", "I visited Paris, TX 75460"),  # Real Paris TX! 
]
