"""Anthropic provider plugin — registers the Anthropic provider with the registry."""
...
from piifilter_provider_anthropic.provider import AnthropicProvider
...
async def register_plugin(registry: "PluginRegistry") -> None:
    """Register the Anthropic provider with the plugin registry.
