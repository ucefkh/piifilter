...
PATTERN_DEFS: list[tuple[str, str, float]] = [
    ...
    # disciplines, and generic entity names.
    ("CITY", r"(?i)(?<=\bin\s)(?!(?:Settings|Config|Configuration|Options|Preferences|Admin|Administrator|System|Dashboard|Profile|Account|General|Security|Network|Users|Groups|Roles|Permissions|Logs|Backup|Notifications|Integrations|Plugins|Extensions|Appearance|Layout|Theme|Support|Manager|Management|Report|Reports|Analytics|Statistics|Overview|Summary|Details|Editor|Viewer|Designer|Developer|Engineer|Moderator|Contributor|Maintenance|Upgrade|Update|Installation|Deployment|Release|Version|Testing|Review|Approval|Approved|Rejected|Pending|Status|Progress|Complete|Complete|Finished|Canceled|Failed|Error|Warning|Info|Success|Critical|Alert|Debug|Trace|Monitor|Metrics|Logging|Audit|Access|Control|Policy|Rule|Rules|Template|Templates|Workflow|Pipeline|Queue|Schedule|Calendar|Agenda|Invoice|Order|Transaction|Payment|Shipping|Billing|Tax|Nature|Science|General|Practice|Theory|Process|Market|Public|Private|Common|Control|Research|Development|Support|Security|Service|History|Current|Future|Recent|Final|Total|Average|Standard|Normal|Special|Maintenance|Text|Mode|Progress|Review|Summary|Detail|Analysis|Backticks|Quotes|Brackets|Parentheses|Here|There|This|That|These|Those|The|A|An|January|February|March|April|May|June|July|August|September|October|November|December|Spring|Summer|Autumn|Winter|Red|Blue|Green|Yellow|Black|White|Gray|Grey|Brown|Orange|Purple|Pink|Violet|Indigo|Gold|Silver|Bronze|Platinum|Diamond|Ruby|Emerald|Sapphire|Jade|Coral|Ivory|Azure|Crimson|Scarlet|Violet|Mathematics|Physics|Chemistry|Biology|Geology|Astronomy|Economics|Philosophy|Psychology|Sociology|Anthropology|Linguistics|Literature|History|Geography|Politics|Law|Engineering|Computing|Medicine|Nursing|Pharmacy|Dentistry|Architecture|Business|Finance|Accounting|Marketing|Design|Education|Training|Learning|Teaching|Coaching|Mentoring|Consulting|Planning|Strategy|Operations|Logistics|Procurement|HR|Human\\s+Resources|IT|Information\\s+Technology|R&D|Research\\s+and\\s+Development|QA|Quality\\s+Assurance|Customer\\s+Success|Customer\\s+Support|Tech\\s+Support|Help\\s+Desk|Desk|Office|Studio|Lab|Laboratory|Workshop|Hub|Center|Centre|Institute|Academy|School|College|University|Department|Division|Section|Unit|Team|Group|Committee|Board|Council|Panel|Task\\s+Force|Working\\s+Group|Squad|Chapter|Region|Zone|Area|District|Sector|Cluster|Node|Module|Component|Element|Fragment|Segment|Block|Layer|Level|Stage|Phase|Step|Part|Piece|Section|Subsection|Category|Class|Type|Kind|Sort|Form|Variant|Version|Revision|Edition|Generation|Iteration|Patch|Hotfix|Release|Build|Compile|Runtime|Deploy|Stage|Prod|Production|Staging|Dev|Development|Test|Testing|Integration|E2E|End\\s+to\\s+End|Unit|Functional|Regression|Performance|Load|Stress|Chaos|Smoke|Sanity|Acceptance|UAT|User\\s+Acceptance|Beta|Alpha|Canary|Feature|Fix|Bug|Issue|Ticket|Story|Epic|Sprint|Backlog|Roadmap|Milestone|Goal|Objective|Initiative|Program|Portfolio|Vendor|Client|Customer|Partner|Stakeholder|Member|Lead|Head|Chief|Officer|Executive|Director|VP|SVP|EVP|C-level|CEO|CFO|CTO|COO|CIO|CMO|CAO|CHRO|founder|Co-founder|Owner|Operator|Administrator|Coordinator|Facilitator|Supervisor|Overseer|Inspector|Analyst|Specialist|Expert|Advisor|Consultant|Agent|Representative|Liaison|Ambassador|Advocate|Champion|Sponsor|Mentor|Coach|Trainer|Instructor|Teacher|Professor|Lecturer|Researcher|Scientist|Scholar|Fellow|Intern|Trainee|Apprentice|Junior|Senior|Principal|Staff|Lead|Architect|Strategist|Planner|Manager|Director|Head|Chief|Officer|Executive|President|Chairman|Chairperson|Chancellor|Dean|Provost|Rector|Registrar|Clerk|Secretary|Treasurer|Auditor|Comptroller|Controller|Bookkeeper|Accountant|Actuary|Underwriter|Broker|Agent|Adjuster|Appraiser|Inspector|Surveyor|Engineer|Technician|Technologist|Operator|Mechanic|Electrician|Plumber|Carpenter|Welder|Mason|Painter|Janitor|Custodian|Guard|Watchman|Patrol|Officer|Sergeant|Lieutenant|Captain|Major|Colonel|General|Admiral|Commander|Chief|Boss|Supervisor|Manager|Lead|Head|Director|Dean|Principal|Rector|Chancellor|President|Chair|Coordinator|Facilitator|Organizer|Planner|Scheduler|Dispatcher|Operator|Controller|Handler|Processor|Manager|Director|Executive|Senior|Junior|Assistant|Associate|Aide|Support|Staff|Worker|Employee|Contractor|Consultant|Temp|Volunteer|Intern|Trainee|Apprentice|Member|Participant|Contributor|Collaborator|Partner|Ally|Friend|Colleague|Peer|Teammate|Classmate|Roommate|Neighbor|Citizen|Resident|Local|Visitor|Guest|Tourist|Traveler|Commuter|Passenger|Rider|Driver|Pilot|Captain|Crew|Crewmate|Sailor|Soldier|Marine|Sailor|Pilot|Officer|Agent|Spy|Detective|Inspector|Investigator|Examiner|Reviewer|Auditor|Checker|Validator|Verifier|Certifier|Assessor|Evaluator|Appraiser|Rater|Scorer|Marker|Grader|Judge|Referee|Arbiter|Umpire|Moderator|Mediator|Arbitrator|Conciliator|Negotiator|Facilitator|Liaison|Coordinator|Organizer|Planner|Scheduler|Dispatcher)\\b)(?-i:[A-Z])[a-z]{2,}\b(?=\s*,|\s*\.|\s*-|\s+and|\s+or|\s*$)", 0.50),
