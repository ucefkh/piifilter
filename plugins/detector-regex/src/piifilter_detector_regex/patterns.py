...
PATTERN_DEFS: list[tuple[str, str, float]] = [
    ...
    ("DOMAIN", r"\b(?!(?:math|sin|cos|tan|log|exp|abs|min|max|sum|avg|and|the|this|that|for|with|from|have|has|had|not|are|was|were|can|will|its|our|their|my|your|his|her|gmail|yahoo|hotmail|outlook|icloud|protonmail|aol|live|msn|google|amazon|microsoft|apple|meta|facebook|twitter|github|gitlab|bitbucket|atlassian|slack|discord|zoom|notion|figma|vercel|netlify|heroku|digitalocean|dropbox|box|drive|wikipedia|youtube|reddit|linkedin|stackoverflow|npm|docker|kubernetes)\.[a-z]{2,}\b)(?!(?:eyJ)[a-zA-Z0-9]+\.[a-zA-Z0-9])(?:[a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}\b(?!:)(?!@)(?<!\.yaml)(?<!\.json)(?<!\.xml)(?<!\.toml)(?<!\.ini)(?<!\.cfg)(?<!\.conf)(?<!\.log)(?<!\.txt)(?<!\.md)(?<!\.rst)(?<!\.html)(?<!\.css)(?<!\.js)(?<!\.ts)(?<!\.py)(?<!\.rb)(?<!\.java)(?<!\.cpp)(?<!\.c)(?<!\.h)(?<!\.go)(?<!\.rs)(?<!\.php)(?<!\.sql)(?<!\.db)(?<!\.pdf)(?<!\.doc)(?<!\.docx)(?<!\.xls)(?<!\.xlsx)(?<!\.ppt)(?<!\.pptx)(?<!\.png)(?<!\.jpg)(?<!\.jpeg)(?<!\.gif)(?<!\.svg)(?<!\.ico)(?<!\.zip)(?<!\.tar)(?<!\.gz)(?<!\.tgz)(?<!\.bz2)(?<!\.xz)(?<!\.7z)(?<!\.lock)(?<!\.env)", 0.75),
