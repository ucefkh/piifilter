"""Find SSN FNs using the exact same benchmark logic (via benchmark module)."""
import sys
import json
import asyncio
...
from benchmarks.recall import (
    load_dataset, stratified_train_test_split, make_regex_adapter, RecallResult
)
...
# Find all test examples with SSN
